...
const TesteDetailsProductModal: ForwardRefRenderFunction<
                  ...
                  <HStack>
                    ...
                    <VStack spacing={0}>
                      <Image
                        ...
                        minW={'20rem'}
                        w={['70vw','70vw', '28vw']}
                        src={showImage === '' ? product.photos[0].url : showImage}
                      />
                    </VStack>
                  <Flex
                  flexWrap="wrap"
            ...
            <VStack flexDir={'column'}>
             <Text
              ...
              <Flex p={'0.5rem'} borderRadius='0.2rem'
                        onClick={() => saveOnCookie({ id: product.id, name: product.name,
                           amount: product.amount, description: product.description, price: product.price, 
                           slug: product.slug, user: product.user, points: product.points, photos: product.photos, createdAt: product.createdAt  })}
                        cursor='pointer' 
...
export default forwardRef(TesteDetailsProductModal);
