...
export const Header = () => {
  return (
    ...
    // <Flex display="flex" bg="itemColor" justify="center" align="center">
    //   <Flex>
    //     <Heading pr="1rem" mt="0.4rem" color="#fff" fontWeight="hairline">
    //       Zaycon
    //     </Heading>
    ...
    // <Box p="0.5rem" bg="itemColor">
    //   <Flex>
    //     <Heading color="#fff" size="xl" fontWeight="hairline">
    //       Zaycon
    //     </Heading>
    //   </Flex>
    ...
    //       href="https://api.whatsapp.com/send?phone=5527999147896&text=Olá, gostaria de saber mais sobre os produtos"
    //     >
    //       <Image cursor="pointer" w="2rem" src="whatsapp.svg" alt="whatsapp" />
    //     </Link>
    //   </HStack>
    //    <HStack ml={[0, 0, '1rem']}>
    //     <Link href="/newSeller">
