...
const Clients = () => {
    ...
    data?.clients.map(client => clientsCreatedAt.push(new Date(client.createdAt).toLocaleDateString('pt-BR', {
        day: '2-digit',
        month: '2-digit',
        year: 'numeric',
    })))

    const chartFilter = clientsCreatedAt.filter(element => week.includes(element))
